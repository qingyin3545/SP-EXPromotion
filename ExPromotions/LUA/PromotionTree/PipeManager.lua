...
function PipeManagerDrawHorizontalPipe(iX, iY, iLength, colour)
  --print("string.format(draw horizontal pipe at (%i, %i) of length %i", iX, iY, iLength))
  if (iLength > 0) then
...
function PipeManagerDrawVerticalPipe(iX, iY, iHeight, colour)
  --print("string.format(draw vertical pipe at (%i, %i) of height %i", iX, iY, iHeight))
  if (iHeight > 0) then
    local pipe = PipeManagerGetPipe(iX, iY, colour)
...
function PipeManagerDrawQuadrantPipe(iX, iY, sType, colour)
  --print("string.format(draw %s quadrant pipe at (%i, %i)", sType, iX, iY))
  local pipe = PipeManagerGetPipe(iX, iY, colour)
